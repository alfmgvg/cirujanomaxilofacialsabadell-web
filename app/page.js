        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:py-24 grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-700">
              ...
              tratamiento de quistes maxilares e implantes dentales, tanto en casos sencillos como complejos.Trabajamos con las mutuas ofrecidas por el hospital QuironSalud del Vallés y atambién a pacientes privados.
            </p>
